...
p0 = axes[0].bar(range(stiffness_versions),number_of_successful_attempt/mc_run_number, alpha=.9)
p1 = axes[1].bar(range(stiffness_versions),successful_rewards_means,yerr=successful_rewards_stds, alpha=.9)
