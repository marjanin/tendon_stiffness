	...
	for babbling_time_cntr in range(len(babbling_times)):
		...
		for mc_counter in range(mc_run_number):
			...
			model = inverse_mapping_fcn(
				...
				log_address="./logs/error_vs_stiffness_test4/scalars/stiffness_v{}/babbling_time_{}_mins/mc_run{}".format(stiffness_ver,babbling_times[babbling_time_cntr], mc_counter),
...
np.save("./results/errors_all_error_vs_stiffness_test4",errors_all)
