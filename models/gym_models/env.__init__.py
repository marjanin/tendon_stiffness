...
## added by Ali Marjaninejad
register(
    id='MyEnv-v0',
    entry_point='gym.envs.mujoco.myenv:HalfCheetahEnv',
    max_episode_steps=1000,
)
##
register(
    id='HalfCheetah_nssu-v3',
    entry_point='gym.envs.mujoco.half_cheetah_v3_notstiff_standup:HalfCheetahEnv',
    max_episode_steps=1000,
    reward_threshold=4800.0,
)
##
register(
    id='HalfCheetah_nsru-v3',
    entry_point='gym.envs.mujoco.half_cheetah_v3_notstiff_run:HalfCheetahEnv',
    max_episode_steps=1000,
    reward_threshold=4800.0,
)
##
register(
    id='NmiLeg-v1',
    entry_point='gym.envs.mujoco.nmi_leg_v1:nmiLegEnv',
    max_episode_steps=1000,
    reward_threshold=5000.0,#reward_threshold(summed velocity) / max_episode_step * simulation_time ..=.. displacement
)

# Tendon-Stiffness (ts) files
register(
    id='TSNMILeg0-v1',
    entry_point='gym.envs.mujoco.TSNMILegv1:TSNMILeg0Env',
    max_episode_steps=1000,
...
register(
    id='TSNMILeg1-v1',
    entry_point='gym.envs.mujoco.TSNMILegv1:TSNMILeg1Env',
    max_episode_steps=1000,
    reward_threshold=5000.0,
)
...
register(
    id='TSNMILeg2-v1',
    entry_point='gym.envs.mujoco.TSNMILegv1:TSNMILeg2Env',
    max_episode_steps=1000,
    reward_threshold=5000.0,
)
...
register(
    id='TSNMILeg3-v1',
    entry_point='gym.envs.mujoco.TSNMILegv1:TSNMILeg3Env',
    max_episode_steps=1000,
    reward_threshold=5000.0,
)
...
register(
    id='TSNMILeg4-v1',
    entry_point='gym.envs.mujoco.TSNMILegv1:TSNMILeg4Env',
    max_episode_steps=1000,
    reward_threshold=5000.0,
)
...
register(
    id='TSNMILeg5-v1',
    entry_point='gym.envs.mujoco.TSNMILegv1:TSNMILeg5Env',
    max_episode_steps=1000,
    reward_threshold=5000.0,
)
...
register(
    id='TSNMILeg6-v1',
    entry_point='gym.envs.mujoco.TSNMILegv1:TSNMILeg6Env',
    max_episode_steps=1000,
    reward_threshold=5000.0,
)
...
register(
    id='TSNMILeg7-v1',
    entry_point='gym.envs.mujoco.TSNMILegv1:TSNMILeg7Env',
    max_episode_steps=1000,
    reward_threshold=5000.0,
)
...
register(
    id='TSNMILeg8-v1',
    entry_point='gym.envs.mujoco.TSNMILegv1:TSNMILeg8Env',
    max_episode_steps=1000,
    reward_threshold=5000.0,
)
